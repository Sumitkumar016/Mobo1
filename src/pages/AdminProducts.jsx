import '../App.css'
import { Star, ShoppingCart, Heart, Eye, Pencil, X } from "lucide-react"
...
import { useGetEditProducts, usePostAdminDeleteProduct } from '../customHooks/adminHooks';
...
export function AdminProducts(){
    ...
    const deleteItem = usePostAdminDeleteProduct();
                        ...
                        {products.length>0?(products.map((product, index)=>{
                            ...
                            <div className='p-6'>
                                ...
                                <div className='flex justify-center items-center gap-3'>
                                    <Link className='w-full' to={`/admin/edit-product/${product._id}`}>
                                    ...
                                    <button onClick={()=>{
                                        ...
                                        deleteItem(product._id)}} className='flex items-center justify-center w-full bg-gradient-to-r from-purple-600 to-blue-600 hover:from-purple-700 hover:to-blue-700 text-white font-semibold py-2 text-lg rounded-lg'>
