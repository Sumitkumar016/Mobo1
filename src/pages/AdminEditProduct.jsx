...
import { useGetEditProducts, usePostAdminEditProduct } from "../customHooks/adminHooks";
...
export default function EditProduct() {
  ...
  const product = useSelector(state=>state.admin.singleProduct);
  ...
  const editProduct = usePostAdminEditProduct();
  const { id } = useParams();
  console.log(id);
  const handleSubmit = (e) => {
    e.preventDefault();
    console.log("Form submitted!");
    editProduct(id, name, brand, price, category, description);
