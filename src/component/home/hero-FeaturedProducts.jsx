    ...
    return <section className='px-4 py-20 bg-gradient-to-br from-gray-50 to-blue-50'>
        <div>
            <div className='text-center mb-16'>
                ...
                <p className='text-xl text-gray-600 max-w-3xl mx-auto'>Discover our most popular mobile accessories with unbeatable deals and lightning-fast delivery</p>
            </div> 
            ...
            <div className='flex item-center justify-center mt-16'>
                <Link to='/products'>
                    <button className="outline-none text-lg font-semibold px-10 py-2 border-2 hover:bg-purple-100 bg-transparent">View All Products</button>
                </Link>
            </div>
        </div>
    </section>
